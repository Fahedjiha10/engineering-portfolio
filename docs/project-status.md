...
|---|---|---|---|
| HurricaneOps | Public Python/Streamlit repository | Active | Business sample data excluded |
| Floorplan Reader | Source, fixture, 12-test suite | 12 tests previously passed | No public sample plan set |
| ESP8266 MQTT IoT | Sanitized firmware | Demonstrated | Credentials required locally |
| Everglades Rescue | C++ source | C++17 syntax passed | Collaborative coursework |
